...
%BCOR=12mm,						% Bindekorrektur, die den Seitenspiegel um 6mm nach rechts verschiebt,
...
\renewcaptionname{ngerman}{\bibname}{Quellen}
...
\newcommand{\autor}{Autor*in}
\newcommand{\bearbeitungszeitraum}{01.01.2024 - 31.03.2024}
\newcommand{\matrikelnr}{123 456}
\newcommand{\kurs}{TFE23-2}
\newcommand{\firma}{Firma (entfällt ggf. bei Studienarbeit)}
\newcommand{\abgabe}{\today}
\newcommand{\betreuerfirma}{Betreuer*in der Firma (entfällt ggf. bei Studienarbeit)}
\newcommand{\betreuerdhbw}{Gutachter*in der DHBW (nur bei Bachelorarbeit erforderlich)}
